...
# =========================================================
print(db_name, "... ", end='')
file_path = "datain/Bib/WebOfScience_Document_search_results.bib"
...
# =========================================================
print(db_name, "... ", end='')
file_path = "datain/CSV/IEEEXplore_export2025.10.14-14.23.20.csv"
...
# =========================================================
print(db_name, "... ", end='')
file_path = "datain/CSV/SpringerNatureLink-SearchResults-2025.09.24.csv"
df = pd.read_csv(file_path, nrows=200)
...
# =========================================================
print(db_name, "... ", end='')
file_path = "datain/CSV/Taylor and Francis search results (28 October 2025).csv"
...
DF.to_csv('dataout/CSV_and_Bib.csv', index=False, sep=";", header=False)
